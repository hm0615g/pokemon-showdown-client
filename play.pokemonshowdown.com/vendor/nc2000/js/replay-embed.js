...
scriptEl.async=false;scriptEl.src=url;
document.head.appendChild(scriptEl);
}

linkStyle('http://161.34.34.171/style/font-awesome.css?v=nc2000-fixed-1');
linkStyle('http://161.34.34.171/style/battle.css?v=nc2000-fixed-1');
linkStyle('http://161.34.34.171/style/replay.css?v=nc2000-fixed-1');
linkStyle('http://161.34.34.171/style/utilichart.css?v=nc2000-fixed-1');

requireScript('http://161.34.34.171/js/lib/ps-polyfill.js?v=nc2000-fixed-1');
requireScript('http://161.34.34.171/vendor/nc2000/replay-config.js?v=nc2000-fixed-1');
requireScript('http://161.34.34.171/js/lib/jquery-1.11.0.min.js?v=nc2000-fixed-1');
requireScript('http://161.34.34.171/js/lib/html-sanitizer-minified.js?v=nc2000-fixed-1');
requireScript('http://161.34.34.171/vendor/nc2000/js/replay-battle-sound.js?v=nc2000-fixed-1');
requireScript('http://161.34.34.171/vendor/nc2000/js/replay-battledata.js?v=nc2000-fixed-1');
requireScript('http://161.34.34.171/vendor/nc2000/pokedex-mini.js?v=nc2000-fixed-1');
requireScript('http://161.34.34.171/vendor/nc2000/pokedex-mini-bw.js?v=nc2000-fixed-1');
requireScript('http://161.34.34.171/vendor/nc2000/data/graphics.js?v=nc2000-fixed-1');
requireScript('http://161.34.34.171/vendor/nc2000/data/pokedex.js?v=nc2000-fixed-1');
requireScript('http://161.34.34.171/vendor/nc2000/data/moves.js?v=nc2000-fixed-1');
requireScript('http://161.34.34.171/vendor/nc2000/data/abilities.js?v=nc2000-fixed-1');
requireScript('http://161.34.34.171/vendor/nc2000/data/items.js?v=nc2000-fixed-1');
requireScript('http://161.34.34.171/vendor/nc2000/data/teambuilder-tables.js?v=nc2000-fixed-1');
requireScript('http://161.34.34.171/js/battle-tooltips.js?v=nc2000-fixed-1');
requireScript('http://161.34.34.171/js/battle.js?v=nc2000-fixed-1');
